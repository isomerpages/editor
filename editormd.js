...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        setToolbar : function() {
			...
			//document.getElementById("editormd").style.display = "none";
    ...
    editormd.markedRenderer = function(markdownToC, options) {
        ...
        markedRenderer.heading = function(text, level, raw) {
            ...
            headingHTML    += (hasLinkReg) ? this.atLink(linkText) : this.atLink(text);
            headingHTML    += "</h" + level + ">";
        ...
        markedRenderer.tablecell = function(content, flags) {
            ...
            return tag + this.atLink(content) + "</" + type + ">\n";
        };
        ...
        markedRenderer.listitem = function(text) {
            if (settings.taskList && /^\s*\[[x\s]\]\s*/.test(text)) 
            {
                ...
                return "<li style=\"list-style: none;\">" + this.atLink(text) + "</li>";
            }
            else 
            {
                return "<li>" + this.atLink(text) + "</li>";
            }
        };
